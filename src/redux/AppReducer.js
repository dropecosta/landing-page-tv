      ...
      item.addEventListener("keydown", event => {
        ...
        switch (event.keyCode) {
          ...
          case keycodes.right:
            ...
            const firstHighlightBtn = document.querySelector(
  ...
  return (dispatch, getState) => {
    items.forEach(item => {
      ...
      item.addEventListener("focus", () => {
        ...
        const focusedRailItemIndex = parseInt(
          document.activeElement.id.replace("rail-item-", "")
        );
        const { show, image, title } = getState().railItems[
          focusedRailItemIndex
        ];
